...
using AirView.Shared.Equality.Internal;

namespace AirView.Shared.Equality
{
    public static class EqualityComparer
    {
        ...
        public static IEqualityComparer<T> ByFields<T>(Func<FieldInfo, bool> predicate)
            where T : class =>
            ByFields<T>(fields => fields.Where(predicate));
        ...
        public static IEqualityComparer<T> ByFields<T>(
            ...
            where T : class =>
            ByMembers<T>(members => selector(members.OfType<FieldInfo>()));
        ...
        public static IEqualityComparer<T> ByMembers<T>(Func<MemberInfo, bool> predicate)
            where T : class => 
            ByMembers<T>(members => members.Where(predicate));
        ...
        public static IEqualityComparer<T> ByMembers<T>(
            ...
            where T : class => 
            MemberwiseEqualityComparerFactory.Create<T>(selector);
        ...
        public static IEqualityComparer<T> ByProperties<T>(Func<PropertyInfo, bool> predicate)
            where T : class => 
            ByProperties<T>(properties => properties.Where(predicate));
        ...
        public static IEqualityComparer<T> ByProperties<T>(
            ...
            where T : class => 
            ByMembers<T>(members => selector(members.OfType<PropertyInfo>()));
        ...
        public static IEqualityComparer<T> ByTaggedFields<T>(params Type[] attributeTypes)
            where T : class => 
            ByFields<T>(field => field.HasAnyAttribute(attributeTypes));
        ...
        public static IEqualityComparer<T> ByTaggedMembers<T>(params Type[] attributeTypes)
            where T : class => 
            ByMembers<T>(member => member.HasAnyAttribute(attributeTypes));
        ...
        public static IEqualityComparer<T> ByTaggedProperties<T>(params Type[] attributeTypes)
            where T : class => 
            ByProperties<T>(property => property.HasAnyAttribute(attributeTypes));
        ...
        public static IEqualityComparer<T> For<T>(Func<T, T, bool> equals, Func<T, int> getHashCode)
            where T : class => 
            new EqualityComparerFunc<T>(equals, getHashCode);
